...
<body id="formulaire">
    <form action="traitAdmin.php" method="post">
        <h1 style="font-style: italic"> Bienvenu sur BASKET' <img src="../../res/ballon_ort.png" alt="ballon" width="50" height="40">RT : Gerant</h1>
       <div class="input">
        ...
        <p class="inscr">Je n'ai pas de <span>compte</span>.Je demande administratin de m'en <span>crée</span> un</p>
        <div align="center">
